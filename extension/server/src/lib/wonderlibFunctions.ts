...
export const WONDERLIB_FUNCTIONS: WonderlibFunction[] = [
  // ===== FILES MODULE =====
  {
    ...
    returnType: "BOOL",
    description:
      'Open file for reading/writing. MODE: "r"=read, "w"=write, "a"=append. Returns TRUE on success.',
    module: "files",
  },
  {
    name: "fclose",
  ...
  },
  {
    ...
    returnType: "BOOL",
    description:
      "Close all files. INTERPRETER: 0=submit, 1=robot, -1=current, -99=all.",
    module: "files",
  },
  {
    name: "feof",
  ...
  },
  {
    name: "fgets",
    params:
      "HANDLE:IN, buffer:OUT, bufferSize:IN, readCharNum:OUT, SEPARATOR:IN",
    returnType: "BOOL",
  ...
  },
  {
    ...
    returnType: "BOOL",
    description:
      "Read floating point number from file terminated by SEPARATOR.",
    module: "files",
  },
  {
    name: "fprint",
  ...
  },
  {
    ...
    returnType: "VOID",
    description:
      "Log error message (requires fileslib_LOG_LEVEL >= LOG_ERROR).",
    module: "files",
  },
  {
    name: "LOGDEBUG",
    ...
    returnType: "VOID",
    description:
      "Log debug message (requires fileslib_LOG_LEVEL >= LOG_DEBUG).",
    module: "files",
  },
  ...
  },
  {
    ...
    description:
      "Create 2D line from two points. Line equation: ax + by + c = 0.",
    module: "geometry",
  },
  {
  ...
  },
  {
    ...
    returnType: "STR_CIRCUMFERENCE2D",
    description:
      "Create 2D circle passing through 3 points. error=TRUE on failure.",
    module: "geometry",
  },
  {
  ...
  },
  {
    ...
    params:
      "line:IN, circumference:IN, intersectionPoint1:OUT, intersectionPoint2:OUT",
    returnType: "INT",
    description:
      "Find intersection of line and circle. Returns number of intersections (0, 1, or 2).",
    module: "geometry",
  },
  {
    name: "RADICAL_AXIS",
  ...
  },
  {
    ...
    description:
      "Create 3D plane from 3 points. Plane equation: ax + by + cz + d = 0.",
    module: "geometry",
  },
  {
  ...
  // ===== LOGICAL MODULE =====
  {
    ...
    returnType: "INT",
    description:
      "Ternary operator for INT: returns TRUEVALUE if CONDITION, else FALSEVALUE.",
    module: "logical",
  },
  {
    name: "BOOL_CHOOSEF",
    ...
    returnType: "REAL",
    description:
      "Ternary operator for REAL: returns TRUEVALUE if CONDITION, else FALSEVALUE.",
    module: "logical",
  },
  {
    ...
    returnType: "E6POS",
    description:
      "Ternary operator for E6POS: returns TRUEVALUE if CONDITION, else FALSEVALUE.",
    module: "logical",
  },
  {
    name: "BOOL_CHOOSESTR",
    ...
    returnType: "CHAR[256]",
    description:
      "Ternary operator for strings: returns TRUEVALUE if CONDITION, else FALSEVALUE.",
    module: "logical",
  },
  {
    name: "INT_CHOOSEF",
    ...
    returnType: "REAL",
    description:
      "Select REAL value by integer index (0-9), returns DEFAULTVALUE if out of range.",
    module: "logical",
  },
  ...
  },
  {
    ...
    returnType: "CHAR[256]",
    description:
      'Convert E6POS to formatted string "{X ..., Y ..., Z ..., A ..., B ..., C ...}".',
    module: "string",
  },
  {
    name: "MID",
    ...
    returnType: "VOID",
    description:
      "Extract substring from STRING starting at OFFSET with given LENGTH.",
    module: "string",
  },
  {
    name: "SPRINTF",
    ...
    returnType: "CHAR[256]",
    description:
      "Format string like printf. Supports %s, %d, %f. Up to 7 parameters.",
    module: "string",
  },
];
