...
const en: Messages = {
  ...
  'info.trailingWhitespaceRemoved': 'KRL: Trailing whitespace removed from {0} lines.',
...
const ru: Messages = {
  ...
  'info.noSystemVariablesFound': 'Системные переменные не найдены в рабочем пространстве.',
...
const tr: Messages = {
  ...
  'info.trailingWhitespaceRemoved': 'KRL: {0} satırdan sondaki boşluklar kaldırıldı.',
  ...
  'info.noSystemVariablesFound': 'Çalışma alanında sistem değişkeni bulunamadı.',
